 ...
 * @version: 
 * @Author: 刘延强
 * @Date: 2021-09-21 16:54:22
 * @LastEditors: 刘延强
 * @LastEditTime: 2021-09-22 22:29:45
-->
...
<template>
  <div>
    ...
    <div class="ele-import-action">
      ...
      <el-button :loading="isLoading" @click="handleRequest" type="primary"
        >下一步</el-button
      >
    </div>
  </div>
  ...
  methods: {
    ...
    async handleRequest() {
      ...
      try {
        ...
        this.$axios
          .post("/personTeam/batchInsertPersonTeam", Data)
          .then(function (res) {
            loading.close();
            if (res.data.code === "0000") {
              ...
              vm.$alert(res.data.message, "导入信息", {dangerouslyUseHTMLString: true});
              return;
            }
          });
      } catch (error) {
