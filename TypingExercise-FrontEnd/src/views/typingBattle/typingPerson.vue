 ...
 * @Descripttion: 金手指的打字界面,打字结束之后可以弹出提示框
...
<template>
  <div>
    ...
    <!-- <el-card class="footPerson" v-if="footPerson">
      <div>
        ...
        >
          ...
          />
          恭喜:&nbsp;<span class="font">{{ this.firstPseron }} </span
          >为冠军，个人积分:&nbsp;{{ this.firstscore }} 分</span
        >
        <span
          style="
            font-weigh: bold;
        ...
        >
          ...
          />
          恭喜:&nbsp;<span class="font">{{ this.secondPseron }} </span
          >为亚军，个人积分:&nbsp;{{ this.secondscore }}分</span
        >
        <span
          style="
            font-weigh: bold;
        ...
        >
          ...
          />
          恭喜:&nbsp;<span class="font">{{ this.thirdPseron }} </span
          >为季军，个人积分:&nbsp;{{ this.thirdscore }} 分</span
        >
      </div>
    </el-card> -->
    ...
    <el-dialog title="打字结束" :visible.sync="centerDialogVisible" width="30%">
      <span style="margin-left: 20%">{{ speedAndRightTime }}</span
      ><br /><br />
      <span style="margin-left: 20%"
        >金手指为您提高速度10%，加成{{ kissSpeedAdd }}KPM</span
      >
  ...
  methods: {
    ...
    sendMessage() {
      ...
      vm.$axios
        ...
        .post("http://message.dmsd.tech:9021/message/wechatmessage", body)
    ...
    selectArticleContent() {
      ...
      vm.$axios
        ...
        .get("/typArticle/SelectArticleContent/a%20girl%20selling%20matches")
    ...
    showKissWordWPM() {
      ...
      //金手指加成前的速度
      vm.kissSpeed1 = parseInt(
        (totalWord / (vm.nowTime - vm.beginTypeTime)) * 60000
      );
      //速度*1.1是金手指加成10%
      vm.kissSpeed = parseInt(
        (totalWord / (vm.nowTime - vm.beginTypeTime)) * 60000 * 1.1
      );
      //速度0.1是金手指加成的速度
      vm.kissSpeedAdd = parseInt(
        (totalWord / (vm.nowTime - vm.beginTypeTime)) * 60000 * 0.1
      );
    },
