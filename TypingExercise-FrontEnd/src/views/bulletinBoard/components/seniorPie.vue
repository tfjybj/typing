 ...
 * @LastEditors: 刘延强
 * @LastEditTime: 2021-09-20 10:41:09
-->
<template>
  <!--为echarts准备一个具备大小的容器dom-->
  <div id="senior" style="width: 100%; height: 200px"></div>
</template>
...
export default {
  ...
  methods: {
    drawLine() {
      this.charts = echarts.init(document.getElementById("senior"));
    ...
    initData() {
      ...
      for (let i = 0; i < this.Table.length; i++) {
        ...
        obj.value = this.Table[i].seniorCount;
        //当前用户所在班级进行高亮显示
