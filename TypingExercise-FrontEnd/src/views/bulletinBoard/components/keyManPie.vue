 ...
 * @LastEditors: 刘延强
 * @LastEditTime: 2021-09-20 10:41:45
-->
<template>
  <!--为echarts准备一个具备大小的容器dom-->
  <div id="keyMan" style="width: 100%; height: 200px"></div>
</template>
...
export default {
  ...
  methods: {
    drawLine() {
      this.charts = echarts.init(document.getElementById("keyMan"));
    ...
    initData() {
      ...
      for (let i = 0; i < this.Table.length; i++) {
        ...
        obj.value = this.Table[i].keyManCount;
        //当前用户所在班级进行高亮显示
